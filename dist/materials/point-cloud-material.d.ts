...
export declare class PointCloudMaterial extends RawShaderMaterial {
    ...
    private static helperMat3;
    private static helperLightPos;
    private static helperLightTargetPos;
    private static helperLightDir;
    private static helperCameraMat3;
    lights: boolean;
    fog: boolean;
    numClipBoxes: number;
    clipBoxes: IClipBox[];
     ...
     */
    elevationAxisLocal: Vector3;
    private cachedElevationAxisLocal;
    private cachedMatrixWorldElements;
    private hasElevationCache;
    private cachedLightFrame;
    private cachedLightSceneId;
    private cachedLightCameraId;
    ...
    directionalLightDirections: Float32Array;
    directionalLightColors: Float32Array;
    pointLightPositions: Float32Array;
    pointLightColors: Float32Array;
    pointLightRanges: Float32Array;
    fov: number;
    elevationAxis: [number, number, number];
    heightMax: number;
    heightMin: number;
    ...
    private updateElevationProjectionParams;
